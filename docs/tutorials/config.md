...
model = dict(
    ...
    test_cfg = dict(  # Config for testing hyperparameters for rpn and rcnn
        ...
        rcnn=dict(  # The config for the roi heads.
            ...
            max_per_img=100,  # Max number of detections of each JPEGImages
...
img_norm_cfg = dict(  # Image normalization config to normalize the input images
    ...
    to_rgb=True
)  # The channel orders of JPEGImages used to pre-training the pre-trained backbone models
train_pipeline = [  # Training pipeline
    dict(type='LoadImageFromFile'),  # First pipeline to load images from file path
    dict(
        type='LoadAnnotations',  # Second pipeline to load annotations for current JPEGImages
    ...
    dict(
        ...
        img_scale=(1333, 800),  # The largest scale of JPEGImages
        keep_ratio=True
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                size_divisor=32),
            dict(
                type='ImageToTensor',  # convert JPEGImages to tensor
                keys=['img']),
            dict(
...
data = dict(
    ...
    train=dict(  # Train dataset config
        ...
        img_prefix='data/coco/train2017/',  # Prefix of JPEGImages path
