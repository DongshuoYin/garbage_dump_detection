...
# init_method needs to be replaced each time when used to avoid bugs, for example: ....../somefile->....../somefile1
dist.init_process_group('gloo', init_method='file:///mnt/nfs/sharedfile/somefile',rank=0, world_size=1)
