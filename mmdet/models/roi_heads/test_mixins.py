...
class BBoxTestMixin(object):
    ...
    def simple_test_bboxes(self,
        ...
        # apply bbox post-processing to each JPEGImages individually
        det_bboxes = []
        det_labels = []
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        for x, img_meta in zip(feats, img_metas):
            # only one JPEGImages in the batch
        ...
        # after merging, bboxes will be rescaled to the original JPEGImages size
...
class MaskTestMixin(object):
    ...
    if sys.version_info >= (3, 7):
        ...
        async def async_test_mask(self,
            ...
            # JPEGImages shape of the first JPEGImages in the batch (only one)
