...
class SABLHead(nn.Module):
    ...
    def bbox_pred_split(self, bbox_pred, num_proposals_per_img):
        """Split batch bbox prediction back to each JPEGImages."""
    ...
    def refine_bboxes(self, rois, labels, bbox_preds, pos_is_gts, img_metas):
        ...
        Args:
            rois (Tensor): Shape (n*bs, 5), where n is JPEGImages number per GPU,
                and bs is the sampled RoIs per JPEGImages.
        ...
        Returns:
            list[Tensor]: Refined bboxes of each JPEGImages in a mini-batch.
        """
