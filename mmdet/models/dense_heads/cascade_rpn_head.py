...
class AdaptiveConv(nn.Module):
    ...
    Args:
        in_channels (int): Number of channels in the input JPEGImages
...
class StageCascadeRPNHead(RPNHead):
    ...
    def get_targets(self,
        ...
        Args:
            anchor_list (list[list]): Multi level anchors of each JPEGImages.
            valid_flag_list (list[list]): Multi level valid flags of each
                JPEGImages.
            gt_bboxes (list[Tensor]): Ground truth bboxes of each JPEGImages.
    ...
    def loss(self,
        ...
        # change per JPEGImages, per level anchor_list to per_level, per_image
