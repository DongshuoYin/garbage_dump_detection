...
class GuidedAnchorHead(AnchorHead):
    ...
    def get_sampled_approxs(self, featmap_sizes, img_metas, device='cuda'):
        ...
        Returns:
            tuple: approxes of each JPEGImages, inside flags of each JPEGImages
        """
        ...
        # for each JPEGImages, we compute inside flags of multi level approxes
        inside_flag_list = []
    ...
    def get_anchors(self,
        ...
        Returns:
            tuple: square approxs of each JPEGImages, guided anchors of each JPEGImages,
                loc masks of each JPEGImages
        """
        num_imgs = len(img_metas)
        ...
        # for each JPEGImages, we compute multi level guided anchors
        guided_anchors_list = []
        loc_mask_list = []
        for img_id, img_meta in enumerate(img_metas):
    ...
    def _ga_shape_target_single(self,
        ...
        Args:
            ...
            img_meta (dict): Meta info of a single JPEGImages.
