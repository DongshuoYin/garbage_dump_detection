...
class YOLOV3Head(BaseDenseHead, BBoxTestMixin):
    ...
    def _get_bboxes_single(self,
        ...
        Args:
            pred_maps_list (list[Tensor]): Prediction maps for different scales
                of each single JPEGImages in the batch.
            scale_factor (ndarray): Scale factor of the JPEGImages arrange as
        ...
        for i in range(self.num_levels):
            ...
            if conf_thr > 0 and (not torch.onnx.is_in_onnx_export()):
                ...
                # with a different input JPEGImages (#4221).
    ...
    def loss_single(self, pred_map, target_map, neg_map):
        """Compute loss of a single JPEGImages from a batch.
    ...
    def get_targets(self, anchor_list, responsible_flag_list, gt_bboxes_list,
        ...
        Args:
            ...
            responsible_flag_list (list[list[Tensor]]): Multi level responsible
                flags of each JPEGImages. Each element is a tensor of shape
                (num_total_anchors, )
    ...
    def _get_targets_single(self, anchors, responsible_flags, gt_bboxes,
        ...
        Args:
            anchors (list[Tensor]): Multi-level anchors of the JPEGImages.
            responsible_flags (list[Tensor]): Multi-level responsible flags of
                anchors
            gt_bboxes (Tensor): Ground truth bboxes of single JPEGImages.
            gt_labels (Tensor): Ground truth labels of single JPEGImages.
