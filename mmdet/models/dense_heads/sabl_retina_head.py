...
class SABLRetinaHead(BaseDenseHead):
    ...
    def get_anchors(self, featmap_sizes, img_metas, device='cuda'):
        ...
        Returns:
            tuple: square approxs of each JPEGImages
        """
    ...
    def get_target(self,
        ...
        Args:
            approx_list (list[list]): Multi level approxs of each JPEGImages.
            inside_flag_list (list[list]): Multi level inside flags of each
                JPEGImages.
            square_list (list[list]): Multi level squares of each JPEGImages.
            gt_bboxes_list (list[Tensor]): Ground truth bboxes of each JPEGImages.
            img_metas (list[dict]): Meta info of each JPEGImages.
            gt_bboxes_ignore_list (list[Tensor]): ignore list of gt bboxes.
            gt_bboxes_list (list[Tensor]): Gt bboxes of each JPEGImages.
        ...
        # compute targets for each JPEGImages
    ...
    def _get_target_single(self,
        ...
        Args:
            flat_approxs (Tensor): flat approxs of a single JPEGImages,
                shape (n, 4)
            inside_flags (Tensor): inside flags of a single JPEGImages,
                shape (n, ).
            flat_squares (Tensor): flat squares of a single JPEGImages,
                shape (approxs_per_octave * n, 4)
            gt_bboxes (Tensor): Ground truth bboxes of a single JPEGImages, \
                shape (num_gts, 4).
            gt_bboxes_ignore (Tensor): Ground truth bboxes to be
                ignored, shape (num_ignored_gts, 4).
            gt_labels (Tensor): Ground truth labels of each box,
                shape (num_gts,).
            img_meta (dict): Meta info of the JPEGImages.
            label_channels (int): Channel of label.
            sampling (bool): Sample Anchors or not.
            unmap_outputs (bool): unmap outputs or not.
        ...
        Returns:
            tuple:
                ...
                - labels_list (Tensor): Labels in a single JPEGImages
                - label_weights (Tensor): Label weights in a single JPEGImages
                - bbox_cls_targets (Tensor): BBox cls targets in a single JPEGImages
                - bbox_cls_weights (Tensor): BBox cls weights in a single JPEGImages
                - bbox_reg_targets (Tensor): BBox reg targets in a single JPEGImages
                - bbox_reg_weights (Tensor): BBox reg weights in a single JPEGImages
                - num_total_pos (int): Number of positive samples \
                    in a single JPEGImages
