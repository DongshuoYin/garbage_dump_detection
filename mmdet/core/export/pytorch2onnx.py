...
def preprocess_example_input(input_config):
    """Prepare an example input JPEGImages for ``generate_inputs_and_wrap_model``.

    Args:
        input_config (dict): customized config describing the example input.

    Returns:
        tuple: (one_img, one_meta), tensor of the example input JPEGImages and \
            meta information for the example input JPEGImages.
