...
def split_combined_polys(polys, poly_lens, polys_per_mask):
    ...
    Args:
        polys (list): a list (length = JPEGImages num) of 1-D tensors
        poly_lens (list): a list (length = JPEGImages num) of poly length
        polys_per_mask (list): a list (length = JPEGImages num) of poly number
            of each mask

    Returns:
        list: a list (length = JPEGImages num) of list (length = mask num) of \
