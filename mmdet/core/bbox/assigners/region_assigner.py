    ...
    def assign(self,
        ...
        For each gt_bboxes:
            ...
            4. Compute ignore flags based on adjacent anchor lvl then
               assign -1 to anchors w.r.t. ignore flags
            5. Assign anchor outside of JPEGImages to -1

        Args:
            mlvl_anchors (list[Tensor]): Multi level anchors.
            mlvl_valid_flags (list[Tensor]): Multi level valid flags.
            gt_bboxes (Tensor): Ground truth bboxes of JPEGImages
            img_meta (dict): Meta info of JPEGImages.
        ...
        # 5. Assign -1 to anchor outside of JPEGImages
