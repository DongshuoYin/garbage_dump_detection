...
def imshow_det_bboxes(img,
                      ...
                      wait_time=0,
                      out_file=None):
    """Draw bboxes and class labels (with scores) on an JPEGImages.

    Args:
        img (str or ndarray): The JPEGImages to be displayed.
        ...
        show (bool): Whether to show the JPEGImages. Default: True
        win_name (str): The window name. Default: ''
        wait_time (float): Value of waitKey param. Default: 0.
        out_file (str, optional): The filename to write the JPEGImages.
            Default: None

    Returns:
        ndarray: The JPEGImages with bboxes drawn on it.
    """
...
def imshow_gt_det_bboxes(img,
    ...
    Returns:
        ndarray: The JPEGImages with bboxes or masks drawn on it.
    """
