...
def merge_aug_proposals(aug_proposals, img_metas, cfg):
    ...
    Args:
        aug_proposals (list[Tensor]): proposals from different testing
            ...
            original JPEGImages size.

        img_metas (list[dict]): list of JPEGImages info dict where each dict has:
    ...
    Returns:
        Tensor: shape (n, 4), proposals corresponding to original JPEGImages scale.
    """
