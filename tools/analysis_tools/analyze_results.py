...
def bbox_map_eval(det_result, annotation):
    """Evaluate mAP of single JPEGImages det result.
...
class ResultVisualizer(object):
    ...
    def evaluate_and_show(self,
        ...
        Args:
            ...
            show_dir (str, optional): The filename to write the JPEGImages.
                Default: 'work_dir'
        ...
        # descending select topk JPEGImages
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='MMDet eval JPEGImages prediction result for each')
